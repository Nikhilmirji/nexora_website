...
const Hero = () => {
  return (
    ...
    >
      ...
      >
        <motion.div
          className="relative w-full text-center flex flex-col items-center justify-center p-0 rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(0,240,255,0.25)] border-2 border-primary/40 hover:shadow-[0_0_50px_rgba(0,240,255,0.4)] transition-shadow duration-300"
          animate={{
            y: [0, -15, 0],
          }}
          transition={{
